    ...
    <div
      ...
      className={classNames(
        deleting
          ...
          : "",
        `rstdi w-auto relative overflow-hidden h-[${height}px] max-h-[${height + 10}px] border-box before: border-box after: border-box`
      )}
    >
      <div
        className={classNames(
          deleting
            ? `transition-all ease-out duration-[${transitionDuration}]`
            : "",
          `delete absolute right-0 top-0 h-full w-full inline-flex justify-start items-center bg-red-300`
        )}
      >
